...
export interface Property {
    $: {
        key: string;
        type: "boolean" | "string" | "action" | "textTemplate" | "integer" | "decimal" | "icon" | "image" | "file" | "datasource" | "attribute" | "association" | "expression" | "enumeration" | "object" | "widgets" | "selection";
        isList?: string;
        isLinked?: string;
        isMetaData?: string;
        defaultValue?: string;
