...
exports.nonLinkedListAttributeNativeOutput = exports.nonLinkedListAttributeWebOutput = void 0;
exports.nonLinkedListAttributeWebOutput = `/**
...
`;
exports.nonLinkedListAttributeNativeOutput = `export interface MyWidgetProps<Style> {
    name: string;
    style: Style[];
    referenceDefault: EditableValue<string>;
    reference: EditableValue<string>;
